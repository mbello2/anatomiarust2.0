...
{
    [Info("PlayerChallenges", "k1lly0u", "2.0.43", ResourceId = 1442)]
    class PlayerChallenges : RustPlugin
    {
        ...
        private void OnEntityDeath(BaseCombatEntity entity, HitInfo info)
        {
            ...
            {                
                ...
                bool isNpc = victim is NPCPlayer;
                ...
                if (!string.IsNullOrEmpty(weapon))
                {
                    ...
                    if (isNpc && configData.Options.NPCKillSeperate)
                    {
                ...
                AddDistance(attacker, isNpc && configData.Options.NPCPVEKills ? Challenges.PVEKillDistance : Challenges.PVPKillDistance, (int)distance);
